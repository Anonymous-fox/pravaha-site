        ...
        function l(e) {
            ...
            switch (n.length) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    o = parseInt(n[0], 10), a = parseInt(n[1], 10), s = parseInt(n[2], 10);
                    break;
                case 4:
                    o = parseInt(n[0], 10), a = parseInt(n[1], 10), s = parseInt(n[2], 10), l = parseInt(n[3], 10)
            }
...
if (document.getElementById("canvas") != null) {
    ...
    let delay = 200,
        tid, rgb = opts.lineColor.match(/\d+/g);
    resizeReset();
    setup();
